...
namespace Srapid\ACL\Http\Controllers;
...
use Srapid\ACL\Forms\PasswordForm;
use Srapid\ACL\Forms\ProfileForm;
use Srapid\ACL\Forms\UserForm;
use Srapid\ACL\Tables\UserTable;
use Srapid\ACL\Http\Requests\CreateUserRequest;
use Srapid\ACL\Http\Requests\UpdatePasswordRequest;
use Srapid\ACL\Http\Requests\UpdateProfileRequest;
use Srapid\ACL\Models\UserMeta;
use Srapid\ACL\Repositories\Interfaces\RoleInterface;
use Srapid\ACL\Repositories\Interfaces\UserInterface;
use Srapid\ACL\Services\ChangePasswordService;
use Srapid\ACL\Services\CreateUserService;
...
use Srapid\ACL\Http\Requests\AvatarRequest;
use Exception;
