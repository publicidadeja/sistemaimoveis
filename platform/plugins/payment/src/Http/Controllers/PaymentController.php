...
namespace Srapid\Payment\Http\Controllers;
...
use Srapid\Payment\Http\Requests\CheckoutRequest;
use Srapid\Payment\Http\Requests\PaymentMethodRequest;
use Srapid\Payment\Http\Requests\PayPalPaymentCallbackRequest;
use Srapid\Payment\Http\Requests\UpdatePaymentRequest;
use Srapid\Payment\Repositories\Interfaces\PaymentInterface;
use Srapid\Payment\Services\Gateways\BankTransferPaymentService;
use Srapid\Payment\Services\Gateways\CodPaymentService;
use Srapid\Payment\Services\Gateways\PayPalPaymentService;
use Srapid\Payment\Services\Gateways\StripePaymentService;
use Srapid\Payment\Tables\PaymentTable;
