...
namespace Srapid\Payment\Providers;
...
use Srapid\Payment\Repositories\Caches\PaymentCacheDecorator;
use Srapid\Payment\Repositories\Eloquent\PaymentRepository;
