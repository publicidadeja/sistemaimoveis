...
Route::group(['namespace' => 'Srapid\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group([
        ...
        // ZAP Imóveis - link para XML feed
        Route::get('zap-imoveis', [
            'as'         => 'real-estate.zap-imoveis',
            'uses'       => 'RealEstateController@getZapImoveisInfo',
            'permission' => 'real-estate.settings',
        ]);
    ...
    if (defined('THEME_MODULE_SCREEN_NAME')) {
        Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
            ...
            // XML Feed para ZAP Imóveis
            Route::get('feed/zapimoveis', [
                'as'   => 'feeds.zapimoveis',
