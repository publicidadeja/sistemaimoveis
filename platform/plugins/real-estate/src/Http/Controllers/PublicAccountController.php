...
use Srapid\Media\Chunks\Exceptions\UploadMissingFileException;
use Srapid\Media\Chunks\Handler\DropZoneUploadHandler;
use Srapid\Media\Chunks\Receiver\FileReceiver;
use Srapid\Media\Repositories\Interfaces\MediaFileInterface;
use Srapid\Media\Services\ThumbnailService;
...
use Srapid\RealEstate\Http\Requests\AvatarRequest;
use Srapid\RealEstate\Http\Requests\SettingRequest;
use Srapid\RealEstate\Http\Requests\UpdatePasswordRequest;
use Srapid\RealEstate\Http\Resources\AccountResource;
use Srapid\RealEstate\Http\Resources\ActivityLogResource;
use Srapid\RealEstate\Http\Resources\PackageResource;
use Srapid\RealEstate\Http\Resources\TransactionResource;
...
class PublicAccountController extends Controller
{
     ...
     * @param \Srapid\RealEstate\Repositories\Interfaces\PackageInterface $packageRepository
     * @param \Srapid\RealEstate\Repositories\Interfaces\TransactionInterface $transactionRepository
     * @return BaseHttpResponse
     */
