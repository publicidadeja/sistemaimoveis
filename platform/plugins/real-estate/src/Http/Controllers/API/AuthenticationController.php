...
use Srapid\ACL\Traits\RegistersUsers;
use Srapid\Base\Http\Responses\BaseHttpResponse;
use Srapid\RealEstate\Http\Requests\LoginRequest;
use Srapid\RealEstate\Http\Requests\RegisterRequest;
use Srapid\RealEstate\Notifications\API\ConfirmEmailNotification;
