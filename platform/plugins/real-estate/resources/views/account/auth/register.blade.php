                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('public.account.register') }}">
                            ...
                            <div class="text-center">
                                {!! apply_filters(BASE_FILTER_AFTER_LOGIN_OR_REGISTER_FORM, null, \Srapid\RealEstate\Models\Account::class) !!}
                            </div>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    ...
    {!! JsValidator::formRequest(\Srapid\RealEstate\Http\Requests\RegisterRequest::class); !!}
@endpush
