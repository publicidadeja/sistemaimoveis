...
namespace Srapid\Contact\Http\Controllers;
...
use Srapid\Contact\Forms\ContactForm;
use Srapid\Contact\Http\Requests\ContactReplyRequest;
use Srapid\Contact\Http\Requests\EditContactRequest;
use Srapid\Contact\Repositories\Interfaces\ContactReplyInterface;
use Srapid\Contact\Tables\ContactTable;
