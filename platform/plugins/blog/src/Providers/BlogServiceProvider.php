...
use Srapid\Shortcode\View\View;
use Illuminate\Routing\Events\RouteMatched;
use Srapid\Base\Traits\LoadAndPublishDataTrait;
use Srapid\Blog\Models\Post;
use Srapid\Blog\Repositories\Caches\PostCacheDecorator;
use Srapid\Blog\Repositories\Eloquent\PostRepository;
use Srapid\Blog\Repositories\Interfaces\PostInterface;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\ServiceProvider;
use Srapid\Blog\Models\Category;
use Srapid\Blog\Repositories\Caches\CategoryCacheDecorator;
use Srapid\Blog\Repositories\Eloquent\CategoryRepository;
use Srapid\Blog\Repositories\Interfaces\CategoryInterface;
use Srapid\Blog\Models\Tag;
use Srapid\Blog\Repositories\Caches\TagCacheDecorator;
use Srapid\Blog\Repositories\Eloquent\TagRepository;
