...
use Srapid\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Srapid\ACL\Http\Controllers\Auth\LoginController;
use Srapid\ACL\Http\Controllers\Auth\ResetPasswordController;
use Srapid\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Srapid\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
