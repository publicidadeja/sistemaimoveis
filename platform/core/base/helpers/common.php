...
use Srapid\Base\Facades\DashboardMenuFacade;
use Srapid\Base\Facades\PageTitleFacade;
use Srapid\Base\Supports\Editor;
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Srapid\Base\Supports\DashboardMenu
     */
