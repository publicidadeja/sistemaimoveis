...
namespace Srapid\Theme;

use Srapid\Theme\Contracts\Theme as ThemeContract;
use Srapid\Theme\Exceptions\UnknownLayoutFileException;
use Srapid\Theme\Exceptions\UnknownPartialFileException;
use Srapid\Theme\Exceptions\UnknownThemeException;
use Closure;
use Exception;
use File;
