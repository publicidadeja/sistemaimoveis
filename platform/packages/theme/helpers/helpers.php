...
use Srapid\Theme\Facades\AdminBarFacade;
use Srapid\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_option')) {
    /**
     * @return \Srapid\Theme\ThemeOption|string
     */
...
if (!function_exists('admin_bar')) {
    /**
     * @return Srapid\Theme\Supports\AdminBar
     */
    function admin_bar()
    {
