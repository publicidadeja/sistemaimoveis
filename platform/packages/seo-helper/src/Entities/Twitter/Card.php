...
namespace Srapid\SeoHelper\Entities\Twitter;

use Srapid\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Srapid\SeoHelper\Contracts\Entities\TwitterCardContract;
use Srapid\SeoHelper\Exceptions\InvalidTwitterCardException;
